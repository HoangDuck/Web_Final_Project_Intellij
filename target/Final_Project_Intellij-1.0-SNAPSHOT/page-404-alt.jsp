        ...
        <div class="h-100" id="leftside-menu-container" data-simplebar="">
            ...
            <ul class="side-nav">
                ...
                <li class="side-nav-item menuitem-active">
                    ...
                    <a href="<c:url value = "./mycourse_student.html"/>" class="side-nav-link ">
                ...
                <li class="side-nav-item">
                    ...
                    <a href="<c:url value = "AddCourse.html"/>" class="side-nav-link">
                ...
                <li class="side-nav-item">
                    ...
                    <a href="<c:url value = "apps-social-feed.html"/>" class="side-nav-link">
                        <i class=" uil-user"></i>
                        <span> My accout</span>
                    </a>
                </li>
