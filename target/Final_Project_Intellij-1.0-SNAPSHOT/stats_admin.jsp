        ...
        <div class="h-100" id="leftside-menu-container" data-simplebar="">
            ...
            <ul class="side-nav">
                ...
                <li class="side-nav-item menuitem-active">
                    <a href="<c:url value = "apps-calendar.html"/>" class="side-nav-link">
                    ...
                    <div class="collapse" id="sidebarEcommerce">
                        <ul class="side-nav-second-level">
                            <li>
                                ...
                                <a href="<c:url value = "./ManagerFile.html"/>">Courses</a>
                            </li>
                            <li>
                                <a href="<c:url value = "apps-ecommerce-products-details.html"/>">Users</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="side-nav-item">
                    <a href="<c:url value = "./profile-admin.html"/>" class="side-nav-link">
                        <i class="uil-user"></i>
                        <span> My accout </span>
                    </a>
                </li>
                ...
                <ul class="list-unstyled topbar-menu float-end mb-0">
                    ...
                    <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            ...
                            <span>
                                        <span class="account-user-name">Minh Thang</span>
